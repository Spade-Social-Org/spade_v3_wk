    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          Stack(
            children: [
              Positioned(right: 90,bottom: 0,top: 0,
            child: Padding(
              padding: const EdgeInsets.only(top: 200,bottom: 10),
              child: SizedBox(
                height: 300,width: 50,
                child: Image.asset("assets/images/Component 1 (1).png"),),
            )),
              Column(
            children: [
              Padding(
              ...
              Row(
                ...
                children: [
                  SizedBox(
                    ...
                    child: Image.asset("assets/images/freepik--character-2--inject-45.png"),
                ...
                child: MaterialButton(
                  ...
                  onPressed: (){
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: ((context) => const InputBodyBuildMenScreen())));
                  }),
              ),
          ),
        ],
