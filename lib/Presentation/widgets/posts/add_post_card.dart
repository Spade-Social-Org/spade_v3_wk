...
//   String date() {
//     if (DateTime.now().difference(widget.posts.createAt).inSeconds < 60) {
//       return "${DateTime.now().difference(widget.posts.createAt).inSeconds}";
//     } else if (DateTime.now().difference(widget.posts.createAt).inMinutes <
//         60) {
//       return "${DateTime.now().difference(widget.posts.createAt).inMinutes}";
//     } else if (DateTime.now().difference(widget.posts.createAt).inHours < 60) {
//       return "${DateTime.now().difference(widget.posts.createAt).inHours}";
//     } else if (DateTime.now().difference(widget.posts.createAt).inDays < 31) {
//       return "${DateTime.now().difference(widget.posts.createAt).inDays}";
//     } else if (DateTime.now().difference(widget.posts.createAt).inWeeks() < 4) {
//       return "${DateTime.now().difference(widget.posts.createAt).inWeeks()}";
//     } else if (DateTime.now().difference(widget.posts.createAt).inMonths() <
//         12) {
//       return "${DateTime.now().difference(widget.posts.createAt).inMonths()}";
//     }
//     return "error";
//   }
...
//                   Positioned(
//                     bottom: 20.height(),
//                     child: Center(child: buildDotRow()),
//                   ),
//                 ],
//               ),
//             ),
...
//   Row buildDotRow(int index) {
//     return Row(
//       mainAxisAlignment: MainAxisAlignment.center,
//       children: List.generate(
//         PostController().allPosts![index].gallery.length,
