      ...
      child: Column(
       // mainAxisAlignment: MainAxisAlignment.start,
        ...
        children: [
          ...
          Padding(
            padding: EdgeInsets.only(left: 21.width(), right: 21.width(), top: 8.height()),
            child: ClipRRect(
          ...
          bubblesColor: const BubblesColor(
              dotPrimaryColor: Colors.red, dotSecondaryColor: Colors.purple),
          circleColor: const CircleColor(start: Colors.yellow, end: Colors.blue),
          likeBuilder: (bool isLiked) {
            return Icon(
              //Icons.favorite_border_sharp,
              post.isLiked ? Icons.favorite_border_outlined : Icons.favorite_border,
          ...
          animationDuration: const Duration(milliseconds: 1000),
                ...
                GestureDetector(
                  ...
                  child: Image.asset("assets/images/Path 740.png", width: 17,)),
                const Spacer(),
                IconButton(
                    onPressed: () {},
                    icon: Icon(
