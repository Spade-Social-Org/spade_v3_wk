...
class DiscoveryScreenNew extends StatefulWidget {
  const DiscoveryScreenNew({super.key});

  @override
  State<DiscoveryScreenNew> createState() => _DiscoveryScreenNewState();
}

class _DiscoveryScreenNewState extends State<DiscoveryScreenNew>
