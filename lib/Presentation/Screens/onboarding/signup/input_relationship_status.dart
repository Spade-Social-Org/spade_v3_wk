...
class InputRelationshipStatusScreen extends StatefulWidget {
  const InputRelationshipStatusScreen({super.key});

  @override
  State<InputRelationshipStatusScreen> createState() => _InputRelationshipStatusScreenState();
}

class _InputRelationshipStatusScreenState extends State<InputRelationshipStatusScreen> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          const Center(
            child: Text(
              "What do you say you are in a relationship ?",
