...
import 'package:spade_v4/Presentation/Screens/Onboarding_screen/onboarding_questions/question20.dart';
...
class _Question19State extends State<Question19> {
  String groupValue = "Planned a special outing or vacation, just for us.";
  bool _q1 = true;
  bool _q2 = false;
  bool _q3 = false;
  bool _q4 = false;
              ...
              children: [
                  ...
                  children: [
                    Container(
                      ...
                      child: RadioListTile(
                        ...
                        title: Text(
                          "Planned a special outing or vacation, just for us.",
                          style: TextStyle(
                    ...
                    Container(
                      ...
                      child: RadioListTile(
                        ...
                        title: Text(
                          "Written a poem, special card, or song for me.",
                          style: TextStyle(
                              color: _q2 ? Colors.white : Colors.black),
                        ),
                        value: "Written a poem, special card, or song for me.",
                      ),
                    ),
                    SizedBox(
                      height: 15,
                    ...
                    Container(
                      ...
                      child: RadioListTile(
                        ...
                        title: Text(
                          'Took time off work to be with me',
                          style: TextStyle(
                              color: _q4 ? Colors.white : Colors.black),
                        ),
                        value: "Took time off work to be with me",
                      ),
                    ),
                    SizedBox(
                      height: 15,
                ...
                Container(
                  ...
                  child: RadioListTile(
                    ...
                    title: Text(
                      'Gave me a really special gift.',
                      style:
                          TextStyle(color: _q3 ? Colors.white : Colors.black),
                    ),
                    value: "Gave me a really special gift.",
                  ),
                ),
                SizedBox(
                  height: 60,
                  ...
                  child: MaterialButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: ((context) => const Question20())));
                      }),
                ),
              ],
            ),
